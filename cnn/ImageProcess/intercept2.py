...
class ImageProcess:
    ...
    def __init__(self, gt_dir, s_dir, output_dir, format_size=[28, 28]):
        # initial parameter
        self.gt_dir = gt_dir
        self.s_dir = s_dir
    ...
    def get_letter(self, img, gt_img):
        ...
        if save_0:
            origin_name_0 = self.get_pic_name(self.final_result_dir[0], self.spt[self.letter_index], True)
            try:
        ...
        if save_255:
            origin_name_255 = self.get_pic_name(self.final_result_dir[2], self.spt[self.letter_index], False)
            try:
...
if __name__ == '__main__':
    ...
    output_dir = "../../result_1103/Challenge2_Training_Task12_Images/"
